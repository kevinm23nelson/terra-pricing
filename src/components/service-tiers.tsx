    ...
    <TooltipProvider>
      <Card className="w-full max-w-6xl mx-auto">
        <CardHeader className="text-center">
          <CardTitle className="text-xl sm:text-2xl">Terra Hosting Client Portal - Development Tiers</CardTitle>
        </CardHeader>
        <CardContent className="p-2 sm:p-6">
            ...
            <div className="inline-block min-w-full align-middle">
              <div className="grid grid-cols-4 gap-4 min-w-[800px]">
                ...
                <div className="space-y-4">
                  <div className="h-24"></div> {/* Increased height from h-20 to h-24 */}
                ...
                {/* Basic Tier */}
                <div className="space-y-4">
                  <div className="text-center p-4 bg-gray-50 rounded-lg h-24 flex flex-col justify-center"> {/* Added fixed height */}
                    <h3 className="text-lg sm:text-xl font-bold">Basic</h3>
                    <p className="text-xl sm:text-2xl font-bold mt-2">$10,000</p>
                    <p className="text-xs sm:text-sm text-gray-600 mt-1">Essential Features</p>
                  </div>
                  {features.map((feature, index) => (
                ...
                {/* Standard Tier */}
                <div className="space-y-4">
                  <div className="text-center p-4 bg-blue-50 rounded-lg border-2 border-blue-200 h-24 flex flex-col justify-center"> {/* Added fixed height */}
                    <h3 className="text-lg sm:text-xl font-bold text-blue-600">Standard</h3>
                    <p className="text-xl sm:text-2xl font-bold mt-2">$12,000</p>
                    <p className="text-xs sm:text-sm text-blue-600 mt-1">Enhanced Support</p>
                  </div>
                  {features.map((feature, index) => (
                    <div key={index} className="flex justify-center min-h-[28px] items-center">
                ...
                {/* Advanced Tier */}
                <div className="space-y-4">
                  <div className="text-center p-4 bg-purple-50 rounded-lg border-2 border-purple-200 h-24 flex flex-col justify-center"> {/* Added fixed height */}
                    <h3 className="text-lg sm:text-xl font-bold text-purple-600">Advanced</h3>
                    <p className="text-xl sm:text-2xl font-bold mt-2">$15,000</p>
                    <p className="text-xs sm:text-sm text-purple-600 mt-1">Analytics Suite</p>
                  </div>
                  {features.map((feature, index) => (
                    <div key={index} className="flex justify-center min-h-[28px] items-center">
          ...
          <div className="mt-8 p-4 bg-gray-50 rounded-lg">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li className="text-sm">Basic tier includes full financial integration and reporting capabilities</li>
              <li className="text-sm">Standard tier adds comprehensive support features with ticketing and live chat</li>
              <li className="text-sm">Advanced tier includes historical data storage with 12+ months retention</li>
              <li className="text-sm">Historical analytics in Advanced tier covers all integrated data sources</li>
              <li className="text-sm">All tiers include core infrastructure setup, monitoring, and documentation</li>
              <li className="text-sm">All tiers include Datadog, website analytics, for tracking visitors, new users, traffic, etc.</li>
              <li className="text-sm">All tiers will have their infrastructure containerized using Docker and deployed on Google Cloud Run</li>
            </ul>
          </div>
        </CardContent>
      </Card>
